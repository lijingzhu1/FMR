...
#Online EWC setting
parser.add_argument('-online_EWC_weight', dest='online_EWC_weight', default=1, help='The weight of EWC loss: beta')
parser.add_argument('-scaling_factor', dest='scaling_factor', default=1, type=float)
parser.add_argument('-max_fisher',type=float, default=1000000)
...
parser.add_argument('-embedding_transfer_norm', dest='embedding_transfer_norm', default='False')
